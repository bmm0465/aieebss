...
const tests = [
  ...
  },
  {
    period: 2,
    title: '소리 듣고 식별하기',
    description: '두 개의 단어를 들려드립니다. 들려준 단어 중 하나를 선택해주세요. (예: "pin"과 "fin"을 들려주면, 들려준 단어를 선택합니다)',
    path: '/test/psf'
  },
  {
    period: 3,
    title: '통합 읽기 평가',
    description: '소리와 철자의 관계를 이해하며 단어와 문장을 읽는 능력을 평가합니다. 무의미 단어 → 실제 단어 → 문장 순서로 진행됩니다.',
    path: '/test/reading'
  },
  {
    period: 4,
    title: '강세 및 리듬 패턴 파악',
    description: '단어를 듣고 올바른 강세 패턴을 선택해주세요. (예: "computer"를 들려주면, 강세가 올바르게 표시된 패턴을 선택합니다)',
    path: '/test/stress'
  },
  {
    period: 5,
    title: '의미 이해',
    description: '단어나 문장을 듣거나 읽고, 알맞은 그림을 선택해주세요. (예: "a red apple"을 들려주거나 보여주면, 빨간 사과 그림을 선택합니다)',
    path: '/test/meaning'
  },
  {
    period: 6,
    title: '주요 정보 파악',
    description: '짧은 대화나 이야기를 듣거나 읽고, 질문에 맞는 답을 선택해주세요. (예: "Tom has a big, blue ball"을 듣고, "What color is the ball?"에 "blue"를 선택)',
    path: '/test/comprehension'
  },
];
