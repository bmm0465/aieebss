...
export async function POST(request: Request) {
  try {
    ...
    const { question, selectedAnswer, correctAnswer, options, userId, authToken } = body;
    ...
    console.log(
      `[MEANING 제출 완료] 사용자: ${userId}, 문제: ${question}, 선택: ${selectedAnswer}, 정답: ${correctAnswer}, 결과: ${isCorrect ? '정답' : '오답'}`,
    );
